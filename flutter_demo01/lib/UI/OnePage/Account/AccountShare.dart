...
class AccountShare extends StatefulWidget {
  const AccountShare({Key key}) : super(key: key);

  @override
  _AccountShareState createState() => _AccountShareState();
}

class _AccountShareState extends State<AccountShare> {
  int iSelIndex = 0;
        ...
        Flexible(
            child: new MediaQuery.removePadding(
                ...
                child: ListView(children: [
                  Container(
                    height: 271,
                    //color: Color.fromRGBO(65, 129, 241, 1),
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        begin: Alignment.topLeft,
                        end: Alignment.bottomRight,
                        colors: [
                          Color.fromRGBO(46, 141, 248, 1),
                          Color.fromRGBO(39, 113, 250, 1),
                        ],
                      ),
                    ),
                    child: Column(
